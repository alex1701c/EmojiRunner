...
cmake -DKDE_INSTALL_QTPLUGINDIR="~/.local/lib/qt/plugins" -DKDE_INSTALL_KSERVICES5DIR="~/.local/share/kservices5" -DEMOJI_FILE_INSTALL_DIR="~/.local/share/emojirunner/" -DCMAKE_BUILD_TYPE=Release  ..
make -j$(nproc)
make install
